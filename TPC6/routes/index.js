  ...
  axios.get('http://localhost:16000/contratos')
    .then(resp => {
      ...
      if (index > ultimo_index) {
        ...
        res.status(200).render("contractList", {lista: lista, tipo: 0 ,pagina : index,ant_pagina : index-1,prox_pagina : index+1,ultima_pagina : resp.data.length ,data: d, cor:"indigo", titulo:"Gestor de Contratos"})
